...
class ChatChannel extends Component {
  ...
  render() {
    ...
    const bubbles = this.memoizedMakeBubbles(
      msgsToRender,
          ...
          >
            ...
            >
              <BxInfiniteScroll
                ...
                nextEnd={channel.isEnd}
                nextLoading={channel.loadingNext || this.state.loadingNext}
                previousDataFn={() => {
                  console.log('Should load next');
                  this.setState({
                    loadingPrev: true
                ...
                previousEnd={false}
                previousLoading={channel.loadingPrev || this.state.loadingPrev}
              >
                { this.makeBubbles(JSON.stringify(messages), JSON.stringify(user))}
              </BxInfiniteScroll>
            </div>
            <Box
              sx={{
